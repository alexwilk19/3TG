...
namespace FaeriesAndTheWizard
{
    public static class TextStorage
    {
        ...
        public static string FirstChoiceO1 = "Not surprising that in your old age you have forgotten how to hold a staff. Very well. ";
        public static string FirstChoiceO12 = "Press the R button now to enter the training room. ";
        ...
        public static string[] TrainingRoomDraw = new string[] {"|------------------------------------|",
        "|   I   |                            |",
        "|       |    x                       |",
        "|--   --|                            |",
        "|                                    |",
